				...
				<!--<div class="box alt container">
					...
					<!-- <div class = "box alt container">
						<input type ='file'/>
						 ...
						 <img id="upl" src="" alt = "Image to Upload" style="display:block; min-width: 600px; min-height: 400px;"/>
						<script>
						...
						<div class = "box alt container">
							<form action="auth.php" method="POST" enctype="multipart/form-data">
         						<input type="file" id="uploaded_img" name="image" /><br ><br >
         						<!--<label for="uploaded_img" id="button_label">Get Started</label>-->
         						<input type="submit"/>
     						</form> 
						</div>
				 ...
				 <!-- <img id="imgcrop" style="display:block; min-width: 600px; min-height: 400px;" src="http://www.jamesnixon.me/master/uploads/food.jpg">  -->
...
<!-- 				<form action="index.php" method="post" onsubmit="return checkCoords();">
				...
				ob_start();
				  if (isset($_POST['run'])) {
					...
					$src = 'http://www.jamesnixon.me/master/uploads/food.jpg';
